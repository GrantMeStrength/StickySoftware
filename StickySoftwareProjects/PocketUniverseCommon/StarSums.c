...
double local_height=10;
 ...
 short int local_day=18;
 short int local_month=9;
 short int local_year=1967;
 short int local_hour=13;
 short int local_minute=40;
 short int local_second=0;
 short int local_timezone=0;
 bool local_daylight=false;
...
void Ephemeris_Planets()
{
	...
	//	SolarSystem.body[p].settime-=local_daylight-local_timezone;
	}
}
...
void Ephemeris_Sun()
{
	...
	//SolarSystem.body[SUN].settime=4;//-=local_daylight-local_timezone;
}
...
void Ephemeris_Moon()
{
	...
	//SolarSystem.body[MOON].settime-=local_daylight-local_timezone;
