...
# ADD LINK32 addrstor.lib /nologo /entry:"wWinMainCRTStartup" /machine:MIPS /out:"WMIPSRel/DemoButtons.exe.MIPS" /subsystem:$(CESubsystem)
...
# SUBTRACT BASE LINK32 /pdb:none /nodefaultlib
# ADD LINK32 addrstor.lib /nologo /entry:"wWinMainCRTStartup" /debug /machine:MIPS /subsystem:$(CESubsystem)
# SUBTRACT LINK32 /pdb:none /nodefaultlib
PFILE=pfile.exe
# ADD BASE PFILE COPY
# ADD PFILE COPY
...
# ADD LINK32 addrstor.lib /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /machine:I386 /out:"x86emRel/scoobysnacks.exe" /windowsce:emulation
EMPFILE=empfile.exe
...
# ADD LINK32 addrstor.lib /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /debug /machine:I386 /windowsce:emulation
EMPFILE=empfile.exe
# ADD BASE EMPFILE -COPY
# ADD EMPFILE -COPY
...
# SUBTRACT BASE LINK32 /pdb:none /nodefaultlib
# ADD LINK32 addrstor.lib /nologo /entry:"wWinMainCRTStartup" /machine:SH3 /out:"WCESHRel/DemoButtons.exe.SH3" /subsystem:$(CESubsystem)
# SUBTRACT LINK32 /pdb:none /nodefaultlib
PFILE=pfile.exe
# ADD BASE PFILE COPY
# ADD PFILE COPY
...
# SUBTRACT BASE LINK32 /pdb:none /nodefaultlib
# ADD LINK32 addrstor.lib /nologo /entry:"wWinMainCRTStartup" /debug /machine:SH3 /subsystem:$(CESubsystem)
# SUBTRACT LINK32 /pdb:none /nodefaultlib
PFILE=pfile.exe
# ADD BASE PFILE COPY
# ADD PFILE COPY
