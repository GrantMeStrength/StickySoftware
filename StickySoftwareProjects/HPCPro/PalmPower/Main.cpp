...
BOOL CALLBACK PowerDialog(HWND hwnd, UINT wMsg, WPARAM wParam, LPARAM lParam)
{
	...
	switch (wMsg) 
	{
		...
		case WM_INITDIALOG:
			...
			graph_bitmap=CreateCompatibleBitmap(hdc,121,110);//CreateBitmap(32,32,8,0,NULL);
		...
		case WM_TIMER:
			...
			Rectangle(hdcgraph,0,0,121,110);
			...
			for (y=0;y<110;y+=10)
				DrawLine(hdcgraph,0,y+5,120,y+5);
...
*/
			...
			BitBlt(hdc,RX,RY,121,110,hdcgraph,0,0,SRCCOPY);
                         ...
                         WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
		...
		icon_bitmap[0]=LoadImage(globalinstance,MAKEINTRESOURCE(IDI_ICON_0),IMAGE_ICON, 16,16,0);
		icon_bitmap[1]=LoadImage(globalinstance,MAKEINTRESOURCE(IDI_ICON_25),IMAGE_ICON, 16,16,0);
		icon_bitmap[2]=LoadImage(globalinstance,MAKEINTRESOURCE(IDI_ICON_50),IMAGE_ICON, 16,16,0);
		icon_bitmap[3]=LoadImage(globalinstance,MAKEINTRESOURCE(IDI_ICON_75),IMAGE_ICON, 16,16,0);
		icon_bitmap[4]=LoadImage(globalinstance,MAKEINTRESOURCE(IDI_ICON_100),IMAGE_ICON, 16,16,0);
		icon_bitmap[5]=LoadImage(globalinstance,MAKEINTRESOURCE(IDI_ICON_DEFAULT),IMAGE_ICON, 16,16,0);
	...
	//	icon_counter=pv/10;
		...
		switch (pv) {
		case 0:nid.hIcon=(HICON)icon_bitmap[0];break;
		case 25:nid.hIcon=(HICON)icon_bitmap[1];break;
		case 50:nid.hIcon=(HICON)icon_bitmap[2];break;
		case 75:nid.hIcon=(HICON)icon_bitmap[3];break;
		case 100:nid.hIcon=(HICON)icon_bitmap[4];break;
		default:nid.hIcon=(HICON)icon_bitmap[5];break;
		}
    ...
    case WM_DESTROY:
		...
		for (icon_counter=0;icon_counter<6;icon_counter++)
