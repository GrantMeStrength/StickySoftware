...
protected:
	...
	afx_msg void OnButtonGotosun();
	afx_msg void OnButtonGotomoon();
	afx_msg void OnMenuAlmanac();
	afx_msg void OnButtonGotoSaturn();
	afx_msg void OnButtonGotoMars();
	afx_msg void OnButtonGotoMerc();
	afx_msg void OnButtonGotoVenus();
	afx_msg void OnButtonGotoJupiter();
	afx_msg void OnUpdateTaskInvert(CCmdUI* pCmdUI);
	afx_msg void OnTaskGrid();
	afx_msg void OnTaskSunmoon();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
