...
ALL : "$(OUTDIR)\ViewMark1.exe" "$(OUTDIR)\ViewMark1.trg"
...
CPP_PROJ=/nologo /MTd /W3 /Gm /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D\
 ...
 /D "_UNICODE" /D "_X86_" /D "_AFXDLL" /Fp"$(INTDIR)\ViewMark1.pch"\
...
ALL : ".\WMIPSRel\testmips.exe" "$(OUTDIR)\ViewMark1.pch"\
 ".\WMIPSRel\testmips.trg"
...
CLEAN :
	...
	-@erase "$(INTDIR)\ViewMark1Doc.obj"
	-@erase "$(INTDIR)\ViewMark1View.obj"
	-@erase ".\WMIPSRel\testmips.exe"
	-@erase ".\WMIPSRel\testmips.ilk"
	-@erase ".\WMIPSRel\testmips.trg"
...
CPP_PROJ=/nologo /MT /W3 /O2 /D "NDEBUG" /D "MIPS" /D "_MIPS_" /D "_WIN32_WCE"\
 /D "UNICODE" /D "_AFXDLL" /Fo"$(INTDIR)\\" /c 
CPP_OBJS=.\ViewMark/
CPP_SBRS=.
...
LINK32_FLAGS=/nologo /entry:"wWinMainCRTStartup" /base:"0x00010000"\
 /incremental:yes /pdb:"WMIPSRel/testmips.pdb" /machine:MIPS\
 /out:"WMIPSRel/testmips.exe" /subsystem:windowsce 
LINK32_OBJS= \
	"$(INTDIR)\CNameRoutines.obj" \
	"$(INTDIR)\ConstRoutines.obj" \
	"$(INTDIR)\DrawSky.obj" \
...
".\WMIPSRel\testmips.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
PFILE_FLAGS=COPY 
PFILE_FILES= \
	".\WMIPSRel\testmips.exe"

".\WMIPSRel\testmips.trg" : "$(OUTDIR)" $(PFILE_FILES)
    $(PFILE) $(PFILE_FLAGS) ".\WMIPSRel\testmips.exe"\
 "$(PFILE_DEST)WCE:testmips.exe">"$(OUTDIR)\testmips.trg"
...
ALL : ".\testunish3.exe" ".\testunish3.trg"
...
CPP_PROJ=/nologo /MT /W3 /O2 /D "NDEBUG" /D "SH3" /D "_SH3_" /D "_WIN32_WCE" /D\
 "UNICODE" /D "_AFXDLL" /Fp"$(INTDIR)\ViewMark1.pch" /Yu"stdafx.h"\
 /Fo"$(INTDIR)\\" /c 
CPP_OBJS=.\ViewMar0/
CPP_SBRS=.
...
LINK32=link.exe
LINK32_FLAGS=/nologo /entry:"wWinMainCRTStartup" /base:"0x00010000"\
 /incremental:yes /pdb:"WCESHDbg/TESTSH3.pdb" /machine:SH3 /out:"testunish3.exe"\
 /subsystem:windowsce 
LINK32_OBJS= \
	"$(INTDIR)\CNameRoutines.obj" \
	"$(INTDIR)\ConstRoutines.obj" \
...
".\testunish3.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
".\testunish3.trg" : "$(OUTDIR)" $(PFILE_FILES)
    $(PFILE) $(PFILE_FLAGS) ".\testunish3.exe"\
 "$(PFILE_DEST)WCE:testunish3.exe">"$(OUTDIR)\testunish3.trg"
...
ALL : ".\x86emRel\plop.exe" ".\x86emRel\plop.trg"
...
CLEAN :
	...
	-@erase "$(INTDIR)\ViewMark1Doc.obj"
	-@erase "$(INTDIR)\ViewMark1View.obj"
	-@erase "..\..\..\..\..\devstudio\myprojects\StarRoutines.obj"
	-@erase ".\x86emRel\plop.exe"
	-@erase ".\x86emRel\plop.ilk"
...
CPP_PROJ=/nologo /MT /W3 /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "STRICT"\
 ...
 "_UNICODE" /D "_X86_" /D "_AFXDLL" /Fp"$(INTDIR)\ViewMark1.pch" /Yu"stdafx.h"\
 /Fo"$(INTDIR)\\" /c 
CPP_OBJS=.\ViewMar2/
CPP_SBRS=.
...
RSC_PROJ=/l 0x809 /fo"x86emRel/plop.res" /d "_WIN32_WCE" /d "UNDER_NT" /d\
 "_WIN32_WCE_EMULATION" /d "UNICODE" /d "NDEBUG" /d "_AFXDLL" 
MTL=midl.exe
MTL_PROJ=
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\ViewMark1.bsc" 
...
LINK32=link.exe
LINK32_FLAGS=/nologo /entry:"wWinMainCRTStartup" /subsystem:windows\
 /incremental:yes /pdb:"x86emRel/plop.pdb" /machine:I386\
 /out:"x86emRel/plop.exe" /windowsce:emulation 
LINK32_OBJS= \
	"$(INTDIR)\CNameRoutines.obj" \
	"$(INTDIR)\ConstRoutines.obj" \
	"$(INTDIR)\DrawSky.obj" \
	...
	"$(INTDIR)\ViewMark1Doc.obj" \
	"$(INTDIR)\ViewMark1View.obj" \
	"..\..\..\..\..\devstudio\myprojects\StarRoutines.obj" \
	".\x86emRel\plop.res"
...
"$(INTDIR)\CNameRoutines.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\ViewMark1.pch"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\CNameRoutines.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
CPP_SWITCHES=/nologo /MT /W3 /O2 /Ob0 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D\
 "STRICT" /D "_WIN32_WCE" /D "UNDER_NT" /D "_WIN32_WCE_EMULATION" /D "UNICODE"\
 /D "_UNICODE" /D "_X86_" /D "_AFXDLL" /Fo"$(INTDIR)\\" /c 
...
"$(INTDIR)\ConstRoutines.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\ViewMark1.pch"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\ConstRoutines.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\MessRoutines.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\ViewMark1.pch"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\MessRoutines.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
CPP_SWITCHES=/nologo /MT /W3 /O2 /Ob0 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D\
 "STRICT" /D "_WIN32_WCE" /D "UNDER_NT" /D "_WIN32_WCE_EMULATION" /D "UNICODE"\
 /D "_UNICODE" /D "_X86_" /D "_AFXDLL" /Fo"$(INTDIR_SRC)\\" /c 

"..\..\..\..\..\devstudio\myprojects\StarRoutines.obj" : $(SOURCE)\
 $(DEP_CPP_STARR) "$(INTDIR_SRC)"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
CPP_SWITCHES=/nologo /MT /W3 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "STRICT"\
 /D "_WIN32_WCE" /D "UNDER_NT" /D "_WIN32_WCE_EMULATION" /D "UNICODE" /D\
 "_UNICODE" /D "_X86_" /D "_AFXDLL" /Fo"$(INTDIR)\\" /c 
