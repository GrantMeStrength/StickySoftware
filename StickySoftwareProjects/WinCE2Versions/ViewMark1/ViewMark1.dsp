...
# ADD CPP /nologo /M$(CECrtMT) /W3 /O2 /D "NDEBUG" /D "MIPS" /D "_MIPS_" /D "_WIN32_WCE" /D "UNICODE" /D "_AFXDLL" /Zm200  /c
RSC=rc.exe
...
# ADD LINK32 /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /pdb:none /machine:I386 /nodefaultlib:"$(CENoDefaultLib)" /out:"x86emRel/plop.exe"
...
DEP_CPP_VIEWMAR=\
	"..\..\HPCPro\ViewMark1\Dialog_Ephemeris.h"\
	".\Data_Dialog.h"\
	".\FindDialog.h"\
	".\globalstuff.h"\
	".\GotoAltAzDialog.h"\
