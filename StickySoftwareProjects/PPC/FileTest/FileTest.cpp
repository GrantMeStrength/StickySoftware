...
CFileTestApp::CFileTestApp(LPCTSTR lpszAppName)
	: CWinApp(lpszAppName)
{
...
CFileTestApp theApp(_T("FileTest"));
...
BOOL CFileTestApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CFileTestDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CFileTestView));
