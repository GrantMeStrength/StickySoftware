...
# ADD CPP /nologo /M$(CECrtMT) /W3 /O2 /D "NDEBUG" /D "MIPS" /D "_MIPS_" /D "_WIN32_WCE" /D "UNICODE" /c
# SUBTRACT CPP /YX /Yc /Yu
RSC=rc.exe
...
# ADD LINK32 /nologo /entry:"wWinMainCRTStartup" /pdb:"WMIPSRel/testmips.pdb" /machine:MIPS /nodefaultlib:"$(CENoDefaultLib)" /out:"PUniverse.exe.MIPS" /subsystem:windowsce
...
# ADD CPP /nologo /M$(CECrtMT) /W3 /O2 /D "NDEBUG" /D "SH3" /D "_SH3_" /D "_WIN32_WCE" /D "UNICODE" /c
# SUBTRACT CPP /YX /Yc /Yu
RSC=rc.exe
...
# ADD LINK32 /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /pdb:none /machine:I386 /nodefaultlib:"$(CENoDefaultLib)" /out:"x86emRel/plop.exe" /windowsce:emulation
