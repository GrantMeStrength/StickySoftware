...
BOOL CViewMark1App::InitInstance()
{
	...
	LoadStdProfileSettings();		// the MRU stff
...
BOOL CAboutDlg::OnInitDialog() 
{
	...
	case 4:	SetDlgItemText(IDC_TOP_TIP,L"Want to quit? You don't need to, but open the keyboard and select CTRL and Q.");break;
