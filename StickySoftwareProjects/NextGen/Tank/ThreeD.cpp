...
// Program pens...
	...
	CPen WhitePen,DKGreyPen,LTGreyPen,BlackPen,ThickPen,BluePen;
...
{
	short int i;
	//CyanPen.CreatePen(PS_SOLID,1,RGB(0,128,128));
	pDC->SelectObject(&CyanPen);

//	pDC->SelectStockObject(BLACK_PEN);//break;
	short int x1,y1,x2,y2,lx,ly;
...
void InitSystem(CDC *pDC)
{
	...
	//CyanPen.CreatePen(PS_SOLID,2,RGB(0,128,128));
